...
const Dashboard: React.FC<DashboardProps> = ({ performance, studentFitScore }) => {
  ...
  const difficultyStats = [
    {
      level: 'Easy',
      correct: performance.difficultyDistribution.easy.correct,
      total: performance.difficultyDistribution.easy.total,
      color: 'green'
    },
    {
      level: 'Medium',
      correct: performance.difficultyDistribution.medium.correct,
      total: performance.difficultyDistribution.medium.total,
      color: 'yellow'
    },
    {
      level: 'Hard',
      correct: performance.difficultyDistribution.hard.correct,
      total: performance.difficultyDistribution.hard.total,
      color: 'red'
    }
  ];
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 border">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600">Avg Time/Question</p>
              <p className="text-2xl font-bold text-gray-900">{performance.averageTime.toFixed(1)}s</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 border">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">{studentFitScore}</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 border">
          ...
          <div className="text-center py-8">
            <div className={`inline-flex items-center px-4 py-2 rounded-full text-sm font-medium ${
              ...
              performanceLevel.color === 'orange' ? 'bg-orange-100 text-orange-800' :
                ...
                <div key={stat.level}>
                  <div className="flex justify-between items-center mb-1">
                    ...
                    <span className="text-sm text-gray-600">
                      {stat.correct}/{stat.total} ({accuracy.toFixed(0)}%)
                    </span>
                  </div>
